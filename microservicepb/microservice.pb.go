...
func (*Microservice) Descriptor() ([]byte, []int) {
	return fileDescriptor_microservice_91264e42e8423e4b, []int{0}
}
...
func (*MicroserviceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_microservice_91264e42e8423e4b, []int{1}
}
...
func (*MicroserviceResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_microservice_91264e42e8423e4b, []int{2}
}
...
type MicroserviceServiceClient interface {
	// Server Streaming
	Microservice(ctx context.Context, in *MicroserviceRequest, opts ...grpc.CallOption) (MicroserviceService_MicroserviceClient, error)
}
...
func (c *microserviceServiceClient) Microservice(ctx context.Context, in *MicroserviceRequest, opts ...grpc.CallOption) (MicroserviceService_MicroserviceClient, error) {
...
type MicroserviceService_MicroserviceClient interface {
	Recv() (*MicroserviceResponse, error)
	grpc.ClientStream
}
...
func (x *microserviceServiceMicroserviceClient) Recv() (*MicroserviceResponse, error) {
...
type MicroserviceServiceServer interface {
	// Server Streaming
	Microservice(*MicroserviceRequest, MicroserviceService_MicroserviceServer) error
}
...
func _MicroserviceService_Microservice_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(MicroserviceServiceServer).Microservice(m, &microserviceServiceMicroserviceServer{stream})
}

type MicroserviceService_MicroserviceServer interface {
	Send(*MicroserviceResponse) error
	grpc.ServerStream
}
...
func (x *microserviceServiceMicroserviceServer) Send(m *MicroserviceResponse) error {
...
func init() {
	proto.RegisterFile("microservice/microservicepb/microservice.proto", fileDescriptor_microservice_91264e42e8423e4b)
}

var fileDescriptor_microservice_91264e42e8423e4b = []byte{
	...
	0x40, 0x5c, 0x2e, 0xa5, 0x84, 0x4f, 0x09, 0xc4, 0x15, 0x4a, 0x0c, 0x06, 0x8c, 0x4e, 0x02, 0x51,
	0x7c, 0xa8, 0xe1, 0x9e, 0xc4, 0x06, 0x0e, 0x6b, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0x4c,
	0x4a, 0x45, 0x7a, 0x9d, 0x01, 0x00, 0x00,
}
